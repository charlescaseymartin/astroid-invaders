...
export class Init1728984122579 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "player" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar(150), "mode" varchar(150), "score" integer NOT NULL, "crewId" varchar, "dateCreated" datetime DEFAULT (datetime('now')), "pilotId" varchar, CONSTRAINT "REL_4a17c62f50d53adaca697934f5" UNIQUE ("pilotId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "player" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar(150) NOT NULL, "mode" varchar(150) NOT NULL, "score" integer NOT NULL, "crewId" varchar NOT NULL, "dateCreated" datetime NOT NULL DEFAULT (datetime('now')), "pilotId" varchar, CONSTRAINT "REL_4a17c62f50d53adaca697934f5" UNIQUE ("pilotId"))`);
        await queryRunner.query(`INSERT INTO "player"("id", "name", "mode", "score", "crewId", "dateCreated", "pilotId") SELECT "id", "name", "mode", "score", "crewId", "dateCreated", "pilotId" FROM "temporary_player"`);
